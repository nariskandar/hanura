...
<nav class="cd-nav-container" id="cd-nav">
	...
	<ul class="cd-nav list-unstyled">
		...
		<li><a href="<?= base_url('rekom/seluruhcalon'); ?>"><span class="menu-icon icon-users"></span>
				<p>Jumlah Calon Pasangan</p>
			</a></li>
        <li><a href="<?= base_url(); ?>chart">
        <span class="menu-icon icon-map"></span>
...
<script src="<?= base_url(); ?>assets/js/pages/form-select2.js"></script>
